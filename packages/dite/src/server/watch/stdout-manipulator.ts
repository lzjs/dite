...
function color(line: string, noClear: any) {
  // coloring errors:
...
export function print(noColors: any, noClear: any, line: any) {
  return console.log(noColors ? line : color(line, noClear));
}

export function deleteClear(line: string) {
...
export function manipulate(line: string) {
